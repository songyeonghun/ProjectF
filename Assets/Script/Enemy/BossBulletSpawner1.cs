...
public class BossBulletSpawner1 : MonoBehaviour
{
    ...
    {      
        ...
        rb4.AddForce(Vector2.right * 10, ForceMode2D.Impulse);
        ...
        rb5.AddForce(Vector2.right * 10, ForceMode2D.Impulse);
        ...
        rb6.AddForce(Vector2.right * 10, ForceMode2D.Impulse);
        ...
        rb7.AddForce(Vector2.right * 10, ForceMode2D.Impulse);
        ...
        rb8.AddForce(Vector2.right * 10, ForceMode2D.Impulse);
